...
| --- | --- | --- |
| [`programs/daed-hook`](programs/daed-hook) | Token-2022 **transfer-hook allowlist program** — the compliance controls (licensed-holder allowlist, issuer freeze) a regulated AED issuer needs, as working code | AED issuers evaluating Solana |
